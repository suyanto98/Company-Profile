    ...
    <>
      <nav className="py-5 bg-white sticky top-0 border-b border-gray-100 z-10">
        <div className="container md:px-12 md:flex md:items-center md:justify-between">
          ...
          <div className="p-5 z-10 bg-white/80 absolute backdrop-blur py-5 opacity-0 w-full top[-400px] transition-all ease-in duration-500 md:p-0 md:flex md:items-center md-space-x-8 md:static md:w-auto md:opacity-100 ">
